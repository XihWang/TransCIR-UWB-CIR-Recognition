...
# ================= 【消融实验】Bottleneck=20 的 1D TransUNet =================
...
print(f"Starting Training TransUNet Model (20-40) on {DEVICE}...")
model.train()
...
# 更改模型保存名字
torch.save(model.state_dict(), os.path.join(SAVE_DIR, 'transunet_model_2040.pth'))
print("TransUNet Model (20-40) Saved.")